...
# Activate the code below to repeat a name by an indicated number of times:
# ---- Repeat name by input variation below ----
...
# puts "He, he. So, what's your last name then?"
#   last_name = gets.chomp
# puts "Welcome #{first_name} #{last_name},
# I've got a lot of good things on sale"
